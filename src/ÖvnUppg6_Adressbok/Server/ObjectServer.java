...
public class ObjectServer {
    ...
    public ObjectServer()throws Exception{
        ...
        try(
            ...
            oos.writeObject(new Kompis(null, "Vems adress behöver du veta",null));
           ...
           while ((inputLine = (String)ois.readObject()) != null) {
                ...
                if (outputPerson == null){
                    ...
                    oos.writeObject(new Kompis("Null", "Denna person finns inte i databasen",LocalDate.of(1967, Month.SEPTEMBER, 27)));
                }
                else{
