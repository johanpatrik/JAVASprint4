package ÖvnUppg4_Väderrapportering;
   ...
   public class ÖvnUppg4_Väderrapportering extends JFrame implements ActionListener {
      ...
      public ÖvnUppg4_Väderrapportering(String gruppAdress, int portNr) 
      ...
      throws UnknownHostException, SocketException, IOException {
         ...
         new ÖvnUppg4_Väderrapportering("234.235.236.237", 12540);
      }
   }
